...
static void (*pGlobalCallBackFunctions[16])(void) = {Null};
...
{
	if(read_bit(EXTI_REG->PR,EXTI_LINE5)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE5);
		pGlobalCallBackFunctions[EXTI_LINE5]();
	}
	if(read_bit(EXTI_REG->PR,EXTI_LINE6)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE6);
		pGlobalCallBackFunctions[EXTI_LINE6]();
	}
	if(read_bit(EXTI_REG->PR,EXTI_LINE7)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE7);
    	pGlobalCallBackFunctions[EXTI_LINE7]();
	}

	if(read_bit(EXTI_REG->PR,EXTI_LINE8)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE8);
		pGlobalCallBackFunctions[EXTI_LINE8]();
	}
	if(read_bit(EXTI_REG->PR,EXTI_LINE9)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE9);
		pGlobalCallBackFunctions[EXTI_LINE9]();
	}
}

void EXTI15_10_IRQHandler(void)
{
	if(read_bit(EXTI_REG->PR,EXTI_LINE10)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE10);
		pGlobalCallBackFunctions[EXTI_LINE10]();
	}
	if(read_bit(EXTI_REG->PR,EXTI_LINE11)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE11);
		pGlobalCallBackFunctions[EXTI_LINE11]();
	}
	if(read_bit(EXTI_REG->PR,EXTI_LINE12)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE12);
    	pGlobalCallBackFunctions[EXTI_LINE12]();
	}

	if(read_bit(EXTI_REG->PR,EXTI_LINE13)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE13);
		pGlobalCallBackFunctions[EXTI_LINE13]();
	}
	if(read_bit(EXTI_REG->PR,EXTI_LINE14)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE14);
		pGlobalCallBackFunctions[EXTI_LINE14]();
	}
	if(read_bit(EXTI_REG->PR,EXTI_LINE15)==1){
		set_bit(EXTI_REG->PR,EXTI_LINE15);
		pGlobalCallBackFunctions[EXTI_LINE15]();
	}
}
