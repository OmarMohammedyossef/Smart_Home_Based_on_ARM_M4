 ...
 */
/*
 *  Description : implementation of RCC driver functions
 *                RCC_voidinit(void)
 *                RCC_voidenable_prepheiral_clock(u8 copy_u8prepheiral_name,u8 copy_u8power_mode)
 *                RCC_voiddisable_prepheiral_clock(u8 copy_u8prepheiral_name)
 */
