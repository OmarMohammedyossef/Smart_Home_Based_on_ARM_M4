 ...
 */
/*
 *  Description:  This file contain configurations of UART peripheral
 *
 *  e.x: type of parity bit, number of stop bits, number of data bits
 *  , the value of baud rate , the job of UART, and interrupts capability
 */
...
/* select UART job */
#define USART_job                  transmitter

/* enable/disable receive complete interrupt */
#define RXC_interrupt              disable
